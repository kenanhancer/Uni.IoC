...
namespace Uni.IoC
{
    public static class IoCConstants
    {
        ...
        public static readonly ConstructorInfo standartInvocationCi = typeof(StandardInvocation).GetConstructor(new Type[] { typeof(object[]), UniConstants.ObjectType, typeof(ProxyMethod) });
    }
}